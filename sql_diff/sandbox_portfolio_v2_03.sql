...
) ENGINE=InnoDB AUTO_INCREMENT=10508 DEFAULT CHARSET=utf8 COMMENT='调仓方案';
...
CREATE TABLE `adjustment_plan_detail` (
  ...
  KEY `idx_fid` (`fid`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=83196 DEFAULT CHARSET=utf8 COMMENT='调仓方案明细';
...
) ENGINE=InnoDB AUTO_INCREMENT=1457 DEFAULT CHARSET=utf8 COMMENT='再平衡队列';
...
) ENGINE=InnoDB AUTO_INCREMENT=698 DEFAULT CHARSET=utf8 COMMENT='事件消息';
...
CREATE TABLE `fee` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=15365 DEFAULT CHARSET=utf8 COMMENT='费用明细';
...
CREATE TABLE `profit_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=39521 DEFAULT CHARSET=utf8 COMMENT='收益情况';
...
CREATE TABLE `recharge` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=1635 DEFAULT CHARSET=utf8 COMMENT='充值';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='推荐奖励';
...
CREATE TABLE `redeem` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=233 DEFAULT CHARSET=utf8 COMMENT='赎回';
...
CREATE TABLE `trans_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=16059 DEFAULT CHARSET=utf8 COMMENT='交易流水';
...
CREATE TABLE `user_asset_detail` (
  ...
  KEY `idx_userId_channelId` (`userId`,`channelId`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=15593 DEFAULT CHARSET=utf8 COMMENT='用户资产详情';
...
) ENGINE=InnoDB AUTO_INCREMENT=1319 DEFAULT CHARSET=utf8 COMMENT='用户测试后分数的保存和风险属性的保存';
