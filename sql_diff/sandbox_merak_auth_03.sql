...
Source Database       : sandbox_merak_auth_03

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2016-10-19 16:30:38
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=3792336 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2958 DEFAULT CHARSET=utf8 COMMENT='登录日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2950 DEFAULT CHARSET=utf8 COMMENT='权限表';
...
CREATE TABLE `site_errors` (
  ...
  `updated_at` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=409 DEFAULT CHARSET=utf8 COMMENT='网站错误记录';
