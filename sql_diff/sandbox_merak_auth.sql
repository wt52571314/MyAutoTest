...
) ENGINE=InnoDB AUTO_INCREMENT=1268009 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=24264 DEFAULT CHARSET=utf8 COMMENT='登录日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2954 DEFAULT CHARSET=utf8 COMMENT='权限表';
...
CREATE TABLE `site_errors` (
  ...
  `updated_at` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=452 DEFAULT CHARSET=utf8 COMMENT='网站错误记录';
