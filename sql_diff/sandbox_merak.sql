...
CREATE TABLE `activities` (
  ...
  `type` varchar(5) NOT NULL COMMENT '方式',
  `capacity` int(2) NOT NULL COMMENT '名额',
  `activity_date` datetime NOT NULL COMMENT '活动日期',
  `from_date` datetime NOT NULL COMMENT '开始日期',
  `end_date` datetime NOT NULL COMMENT '结束日期',
  `province` varchar(32) NOT NULL COMMENT '省份',
  `city` varchar(32) NOT NULL DEFAULT '' COMMENT '市',
  `status` varchar(10) NOT NULL DEFAULT 'OFF' COMMENT '状态',
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=71059 DEFAULT CHARSET=utf8 COMMENT='行为记录';
...
-- ----------------------------
-- Table structure for dic_cities
-- ----------------------------
...
CREATE TABLE `dic_cities` (
  ...
  `status` varchar(6) NOT NULL DEFAULT 'ON' COMMENT '状态，启用ON 关闭 OFF',
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=4277 DEFAULT CHARSET=utf8 COMMENT='异常日志表';

-- ----------------------------
-- Table structure for from_fa_user
-- ----------------------------
DROP TABLE IF EXISTS `from_fa_user`;
CREATE TABLE `from_fa_user` (
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `channel_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '渠道ID',
  `real_name` varchar(100) NOT NULL DEFAULT '' COMMENT '真实姓名',
  `fa_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '理财顾问id',
  `created_by` int(11) NOT NULL DEFAULT '0' COMMENT '创建者',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` int(11) NOT NULL DEFAULT '0' COMMENT '更新者',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`user_id`,`channel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='大客户自客表';
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='帮助中心-模块';
...
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='帮助中心-QA';
...
CREATE TABLE `invitation_code` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3336 DEFAULT CHARSET=utf8 COMMENT='邀请码';
...
CREATE TABLE `market_apply` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='灵玑活动-报名';

-- ----------------------------
-- Table structure for market_source
-- ----------------------------
DROP TABLE IF EXISTS `market_source`;
CREATE TABLE `market_source` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `source_code` varchar(50) NOT NULL DEFAULT '' COMMENT '来源标识',
  `source_name` varchar(50) NOT NULL DEFAULT '' COMMENT '来源名称',
  `created_by` int(11) NOT NULL DEFAULT '0' COMMENT '创建者',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` int(11) NOT NULL DEFAULT '0' COMMENT '更新者',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_code` (`source_code`),
  KEY `idx_code_name` (`source_code`,`source_name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='报名渠道表';
...
) ENGINE=InnoDB AUTO_INCREMENT=625 DEFAULT CHARSET=utf8 COMMENT='充值表';
...
CREATE TABLE `recommend_level` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='MGM佣金等级配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=731 DEFAULT CHARSET=utf8 COMMENT='投资者回馈';
...
CREATE TABLE `site_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_channelId_title` (`channel_id`,`title`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='站内信';
...
CREATE TABLE `site_message_status` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`user_id`,`channel_id`)
) ENGINE=InnoDB AUTO_INCREMENT=61694 DEFAULT CHARSET=utf8 COMMENT='站内信用户状态表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2215 DEFAULT CHARSET=utf8 COMMENT='子账户';
...
CREATE TABLE `user_channel` (
  ...
  `market_source` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '客户来源',
...
) ENGINE=InnoDB AUTO_INCREMENT=12906 DEFAULT CHARSET=utf8 COMMENT='合同';
...
-- ----------------------------
-- Table structure for user_source_conversion
-- ----------------------------
DROP TABLE IF EXISTS `user_source_conversion`;
CREATE TABLE `user_source_conversion` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `channel_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '渠道ID',
  `market_source` varchar(50) NOT NULL DEFAULT '' COMMENT '来源渠道Code',
  `source_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '来源总人数',
  `register_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '注册总人数',
  `join_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '邀请码（加入）总人数',
  `test_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '问卷总人数',
  `bind_card_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '绑卡（开户）总人数',
  `recharge_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '入金总人数',
  `adjust_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '调仓总人数',
  `again_recharge_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '再次入金总人数',
  `all_withdrawal_count` int(11) NOT NULL,
  `newset` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '是否是最新数据',
  `created_at` datetime DEFAULT NULL COMMENT '创建日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='客户来源转化';
