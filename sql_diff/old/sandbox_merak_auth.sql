...
Source Database       : sandbox_merak_auth

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2016-09-12 15:17:51
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=1265047 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
CREATE TABLE `applications` (
  ...
  `app_channel_id` int(11) NOT NULL DEFAULT '0' COMMENT '应用渠道ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='应用系统';
...
CREATE TABLE `log_login` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23832 DEFAULT CHARSET=utf8 COMMENT='登录日志表';
...
CREATE TABLE `rights` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2924 DEFAULT CHARSET=utf8 COMMENT='权限表';
...
CREATE TABLE `roles` (
  ...
  `role_value` int(11) unsigned DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=479 DEFAULT CHARSET=utf8 COMMENT='角色表';
...
CREATE TABLE `site_errors` (
  ...
  `updated_at` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=332 DEFAULT CHARSET=utf8 COMMENT='网站错误记录';
