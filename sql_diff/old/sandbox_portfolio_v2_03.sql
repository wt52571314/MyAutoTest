...
Source Database       : sandbox_portfolio_v2_03

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2016-09-26 14:10:10
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=10208 DEFAULT CHARSET=utf8 COMMENT='调仓方案';
...
CREATE TABLE `adjustment_plan_detail` (
  ...
  KEY `idx_fid` (`fid`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=80679 DEFAULT CHARSET=utf8 COMMENT='调仓方案明细';
...
) ENGINE=InnoDB AUTO_INCREMENT=1402 DEFAULT CHARSET=utf8 COMMENT='再平衡队列';
...
CREATE TABLE `baseline_month` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10687 DEFAULT CHARSET=utf8 COMMENT='基准线历史';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='标杆信息';
...
CREATE TABLE `benchmark_month` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10340 DEFAULT CHARSET=utf8 COMMENT='标杆每月汇总';
...
CREATE TABLE `event_message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_u_c_t_t` (`user_id`,`channel_id`,`trans_no`,`trans_type`)
) ENGINE=InnoDB AUTO_INCREMENT=613 DEFAULT CHARSET=utf8 COMMENT='事件消息';
...
CREATE TABLE `fee` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=14447 DEFAULT CHARSET=utf8 COMMENT='费用明细';
...
CREATE TABLE `fee_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='费用模板';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='全局设置';
...
CREATE TABLE `product_rcmd` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8 COMMENT='产品推荐表';
...
CREATE TABLE `profit_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=38762 DEFAULT CHARSET=utf8 COMMENT='收益情况';
...
CREATE TABLE `recharge` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=1533 DEFAULT CHARSET=utf8 COMMENT='充值';
...
CREATE TABLE `redeem` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8 COMMENT='赎回';
...
CREATE TABLE `trans_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=15005 DEFAULT CHARSET=utf8 COMMENT='交易流水';
...
CREATE TABLE `user_asset_detail` (
  ...
  KEY `idx_userId_channelId` (`userId`,`channelId`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=15158 DEFAULT CHARSET=utf8 COMMENT='用户资产详情';
...
) ENGINE=InnoDB AUTO_INCREMENT=15265 DEFAULT CHARSET=utf8 COMMENT='用户方案推荐';
...
) ENGINE=InnoDB AUTO_INCREMENT=1268 DEFAULT CHARSET=utf8 COMMENT='用户测试后分数的保存和风险属性的保存';
...
) ENGINE=InnoDB AUTO_INCREMENT=53946 DEFAULT CHARSET=utf8 COMMENT='模型历史';
