...
CREATE TABLE `adjustment_plan_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=115030 DEFAULT CHARSET=utf8 COMMENT='调整方案';
...
) ENGINE=InnoDB AUTO_INCREMENT=4313 DEFAULT CHARSET=utf8 COMMENT='再平衡队列';
...
CREATE TABLE `benchmark_month` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10359 DEFAULT CHARSET=utf8 COMMENT='标杆每月汇总';
...
) ENGINE=InnoDB AUTO_INCREMENT=412 DEFAULT CHARSET=utf8 COMMENT='事件消息';
...
) ENGINE=InnoDB AUTO_INCREMENT=58061 DEFAULT CHARSET=utf8 COMMENT='费用明细';
...
) ENGINE=InnoDB AUTO_INCREMENT=12887 DEFAULT CHARSET=utf8 COMMENT='产品贴标';
...
CREATE TABLE `product_lable_copy` (
  ...
  `benchmark_id` varchar(64) DEFAULT '' COMMENT '标杆ID',
  `market` varchar(255) DEFAULT NULL COMMENT '市场，详细见字典表0表示国内市场、1表示海外市场、2表示商品市场',
  `investType` varchar(255) DEFAULT NULL COMMENT '投资类型、详细见字典表',
  `trend` varchar(255) DEFAULT NULL COMMENT '0表示做多1表示做空',
  `ts` varchar(255) DEFAULT NULL COMMENT '是战略还是战术，0标示战略1表示战术',
  `lever` varchar(255) DEFAULT NULL COMMENT '是否杠杆 0表示是、1表是否',
  `dsc` varchar(255) DEFAULT NULL COMMENT '产品描述',
  `level` int(11) DEFAULT NULL COMMENT '0表示一般、1表示精选 2表示黑名单',
  `orilevel` int(11) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `creator` varchar(64) DEFAULT NULL COMMENT '创建人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `updator` varchar(64) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='产品贴标';
...
CREATE TABLE `product_rcmd` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=370 DEFAULT CHARSET=utf8 COMMENT='产品推荐表';
...
-- ----------------------------
-- Table structure for product_rcmd_choice
-- ----------------------------
DROP TABLE IF EXISTS `product_rcmd_choice`;
CREATE TABLE `product_rcmd_choice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `benchmarkId` varchar(255) NOT NULL COMMENT '标杆市场ID',
  `productId` varchar(255) NOT NULL COMMENT '产品ID',
  `sequence` int(11) NOT NULL COMMENT '排序',
  ...
  `ptype` int(1) NOT NULL DEFAULT '0' COMMENT '优黑选类型，0优选，1黑选',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7649 DEFAULT CHARSET=utf8 COMMENT='产品推荐表';
...
-- ----------------------------
-- Table structure for product_score_copy1
-- ----------------------------
DROP TABLE IF EXISTS `product_score_copy1`;
CREATE TABLE `product_score_copy1` (
  `pid` varchar(255) NOT NULL COMMENT '产品id',
  `benchmarkid` varchar(255) DEFAULT NULL,
  `excessReturn` decimal(20,6) DEFAULT NULL COMMENT '超额报酬',
  `maxDrawdown` decimal(20,6) DEFAULT NULL COMMENT '最大回撤',
...
CREATE TABLE `profit_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=126935 DEFAULT CHARSET=utf8 COMMENT='收益情况';
...
CREATE TABLE `recharge` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=5183 DEFAULT CHARSET=utf8 COMMENT='充值';
...
CREATE TABLE `redeem` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=212 DEFAULT CHARSET=utf8 COMMENT='赎回';
...
CREATE TABLE `trans_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`userId`,`channelId`)
) ENGINE=InnoDB AUTO_INCREMENT=112467 DEFAULT CHARSET=utf8 COMMENT='交易流水';
...
CREATE TABLE `user_asset_detail` (
  ...
  KEY `idx_userId_channelId` (`userId`,`channelId`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=20052 DEFAULT CHARSET=utf8 COMMENT='用户资产详情';
...
) ENGINE=InnoDB AUTO_INCREMENT=15301 DEFAULT CHARSET=utf8 COMMENT='用户方案推荐';
...
) ENGINE=InnoDB AUTO_INCREMENT=988 DEFAULT CHARSET=utf8 COMMENT='用户测试后分数的保存和风险属性的保存';
