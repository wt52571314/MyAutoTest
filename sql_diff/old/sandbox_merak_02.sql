...
Source Database       : sandbox_merak_02

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2016-09-13 16:56:48
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=67602 DEFAULT CHARSET=utf8 COMMENT='行为记录';
...
CREATE TABLE `channel` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='渠道信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=969 DEFAULT CHARSET=utf8 COMMENT='异常日志表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='帮助中心-模块';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='帮助中心-QA';
...
CREATE TABLE `invitation_code` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1662 DEFAULT CHARSET=utf8 COMMENT='邀请码';
...
CREATE TABLE `market_apply` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=921 DEFAULT CHARSET=utf8 COMMENT='灵玑活动-报名';
...
) ENGINE=InnoDB AUTO_INCREMENT=169 DEFAULT CHARSET=utf8 COMMENT='充值表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='投资者回馈';
...
CREATE TABLE `site_message_status` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_userId_channelId` (`user_id`,`channel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='站内信用户状态表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1350 DEFAULT CHARSET=utf8 COMMENT='子账户';
...
) ENGINE=InnoDB AUTO_INCREMENT=5298 DEFAULT CHARSET=utf8 COMMENT='合同';
