...
from test_room.interface_test_farmework.xml2dict import XML2Dict
...
def countflag(flag, ok, ng, nt):
    calculation = {'OK': lambda: [ok+1, ng, nt],  'NG': lambda: [ok, ng+1, nt],                'NT': lambda: [ok, ng, nt+1]}
