...
BaseURL = 'http://bbae-api-develop.bbaecdn.com'  # 测试环境
List_interface_get = {
    BaseURL+'/api/v1/trade/asset?stockType=1&usAccountID=66': '资产'
    , BaseURL+'/api/v1/security/userInfo': '用户信息'
    , BaseURL+'/api/v1/us/account/getCouponView?usAccountID=66': '我的福利'
    , BaseURL+'/api/v1/trade/positions?paged=false&skip=0&take=5&usAccountID=66': '我的持仓'
    ...
    , BaseURL+'/api/v1/us/account/baseInfo?usAccountID=66': '开户基础信息'
    ...
    , BaseURL+'/api/v1/trade/completedHistory?startDate=05/24/2016&endDate=06/23/2016&filter=\
                0&skip=0&take=20&stockType=1&usAccountID=66': '交易记录之已完成交易'
    ...
    , BaseURL+'/api/v1/us/account/getApexPdf?usAccountID=66&type=CONFIRM&pageNo=0&pageCnt=50': '相关文档之交易确认'
    , BaseURL+'/api/v1/us/account/getApexPdf?usAccountID=66&type=STATEMENT&pageNo=0&pageCnt=50': '相关文档之账户结单'
    , BaseURL+'/api/v1/us/account/getApexPdf?usAccountID=66&type=TAX&pageNo=0&pageCnt=50': '相关文档之税务文档'
    , BaseURL+'/api/v1/us/account/isBoundUsBank?usAccountID=66': '转出是否绑定银行'
