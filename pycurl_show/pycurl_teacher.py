...
import StringIO
import urllib
# 在windows安装的话http://pycurl.sourceforge.net/download/
...
def post_file(url, post_file):
    # print pycurl.version_info()
    """这个函数创建一个同 libcurl中的CURL处理器相对应的Curl对象.Curl对象自动的设置CURLOPT_VERBOSE为0,
    CURLOPT_NOPROGRESS为1,提供一个默认的CURLOPT_USERAGENT和设置CURLOPT_ERRORBUFFER指向一个私有的错误缓冲区."""
